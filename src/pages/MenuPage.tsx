...
export function MenuPage({ onNavigate }: { onNavigate: (page: string) => void }) {
  ...
  return (
    <div className="min-h-screen bg-[#EFE3D7]">
      <Header alwaysLight onNavigate={(target) => {
        if (target === 'menu') {
          window.scrollTo(0, 0);
        } else {
          onNavigate('home');
      ...
      <div
        ...
        style={{
          height: '70vh',
          marginTop: '80px',
          backgroundImage: `url('https://images.unsplash.com/photo-1758810742443-b82f48355828?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxlbGVnYW50JTIwY2F0ZXJpbmclMjB0YWJsZSUyMHNldHVwfGVufDF8fHx8MTc1OTk5NjExMnww&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral')`,
          backgroundSize: 'cover',
          backgroundPosition: 'center',
      ...
      >
        ...
        >
          <h1 className="text-[#36394C] mb-6" style={{ fontFamily: 'Libre Baskerville, Georgia, serif', fontWeight: 700, fontSize: 'clamp(44px, 5vw, 48px)', letterSpacing: '-0.02em', lineHeight: 1.15 }}>Our Menu</h1>
          <p className="text-[#36394C] mb-8 max-w-2xl mx-auto" style={{ fontFamily: 'Montserrat, sans-serif', fontSize: '18px', fontWeight: 500, lineHeight: 1.5 }}>
            Tradition meets care. Flavor, refined.
          </p>
          <button
          ...
          >
            <span className="relative z-10">REQUEST MENU</span>
      ...
      {/* Intro Section */}
      <div ref={introRef} className="bg-[#EFE3D7] py-20 px-10">
        <p
        ...
        >
          Appetizers. Desserts. Beverages. Full stations or à la carte. Tailored to your event.
        </p>
      </div>
        ...
        <div className="max-w-[1200px] mx-auto">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div className="order-1 md:order-2">
              <p className="section-number mb-2" style={{ fontSize: '11px' }}>
                Special Touches
              </p>
              <h2 className="text-[#36394C] mb-4">ENHANCEMENTS</h2>
              <div className="w-[60px] h-[1px] bg-[#C4A46A] mb-6" />
              <p className="text-[#36394C]/80 mb-8">
                Full stations. Hot and cold options. <span style={{ fontStyle: 'italic' }}>Call for custom packages.</span>
              </p>
              <button
                className="relative bg-[#5B2E34] text-[#EFE3D7] px-8 py-3 rounded-[12px] shadow-lg hover:bg-[#4F272C] hover:shadow-xl transition-all duration-300"
                style={{ fontWeight: 500, letterSpacing: '0.02em', fontFamily: 'Montserrat, sans-serif' }}
              >
                <span className="relative z-10">PRINT MENU</span>
                <div className="absolute inset-0 bg-gradient-to-br from-white/10 to-transparent opacity-0 hover:opacity-100 transition-opacity duration-300" />
              </button>
            </div>
          </div>
            ...
            <div>
              ...
              <div className="flex flex-wrap gap-4">
                ...
                <button
                  ...
                  className="bg-[#EFE3D7] text-[#5B2E34] px-8 py-4 rounded-[12px] border-2 border-[#5B2E34] hover:bg-[#5B2E34] hover:text-[#EFE3D7] transition-all duration-300"
                  style={{ fontWeight: 500, letterSpacing: '0.02em', fontFamily: 'Montserrat, sans-serif' }}
                >
                  VIEW FULL GALLERY
                </button>
      ...
      <div className="py-20 px-6 bg-[#EFE3D7]">
        <div className="max-w-[900px] mx-auto">
          ...
          <div className="bg-[#EFE3D7] rounded-2xl border border-[#C9C3BA] shadow-lg p-8 md:p-12">
            <div className="grid md:grid-cols-2 gap-8 items-center mb-8">
              {/* Business Card Image */}
              <div className="flex justify-center">
                <img 
                  src="https://images.unsplash.com/photo-1542006202-019927e93874?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&q=80&w=800"
